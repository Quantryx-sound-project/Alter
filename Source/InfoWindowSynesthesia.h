...
class SynesthesiaInfoWindow : public ModuleInfoWindow
{
public:
    SynesthesiaInfoWindow()
        : ModuleInfoWindow ("Synesthesia - Educational Guide")
    {
...
private:
    ...
    public:
        ...
        void paint (juce::Graphics& g) override
        {
            ...
            g.drawText ("Synesthesia", area.removeFromTop (40), juce::Justification::centred);
