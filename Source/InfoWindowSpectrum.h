...
private:
    ...
    public:
        ...
        void paint (juce::Graphics& g) override
        {
            ...
            drawBody (g, area,
                "Resampling: bins (512/1024/2048) are remapped to 2048 render points\n"
                "on a log-X scale. For each render point the frequency is calculated and\n"
                "the corresponding bin is found with interpolation between neighbors.\n\n"
            ...
            // SECTION: BINS
            drawSectionTitle (g, area, "BIN COUNT SETTING (512 / 1024 / 2048)");
            drawBody (g, area,
                "This parameter controls how many FFT bins are displayed (grouped).\n"
                "The plugin sends 2048 bins. Reduction is done by grouping:\n\n"
                "2048 bins  ->  full resolution, every bin visible\n"
                "  Use case: detailed analysis, sound design, EQ tuning\n\n"
                "1024 bins  ->  2 bins averaged into 1\n"
                "  Visual mode: group maximum | Measurement: power average\n"
                "  Use case: balance between detail and readability\n\n"
                "512 bins   ->  4 bins grouped into 1\n"
                "  Smoother, less jagged look, good for high BPM\n"
                "  Use case: live monitoring, broadcast");
            area.removeFromTop (8);
            ...
            // SECTION: PEAK HOLD
            drawSectionTitle (g, area, "PEAK HOLD CURVE");
            drawBody (g, area,
                "Peak Hold shows a second curve above the main one - brighter, thinner.\n"
                "It captures the maximum reached value of each bin and slowly decays.\n\n"
                "Algorithm:\n"
                "  peakHold[i] = max( currentValue[i], peakHold[i] * 0.998 )\n"
                "  Decay = 0.998 per frame - at 30fps drops ~10 dB over ~16 seconds\n\n"
                "Use cases:\n"
                "  Quick glance at maxima without tracking the moving curve\n"
                "  Good for: identifying resonances, spotting problematic frequency bands\n"
                "  In measurement mode: precise dBFS peak readout");
            area.removeFromTop (8);
            ...
            drawBody (g, area,
                ...
                "3. Peak Hold curve is available in both modes.\n"
                "   In measurement mode: thin bright curve shows maxima in dBFS.\n\n"
                "Recommendation:\n"
