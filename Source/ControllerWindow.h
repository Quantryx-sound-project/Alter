...
private:
    ...
    // ===== helpers =====
    void finalizeDrag();
    void setEditorVisible (bool rms, bool spec, bool osc, bool syn, bool chladni);
    ...
    juce::ToggleButton tbSpecPeakHold;      // Peak hold krivka
    ...
    juce::Slider   sChladniM,     sChladniN;     // IncDecButtons, range 1–8
    juce::Label    lblChladniAR;
    juce::Slider   sChladniAR;                   // LinearHorizontal, 0.25–4.0
    juce::Label    lblChladniSharp;
    juce::Slider   sChladniSharp;                // LinearHorizontal, 0–1
